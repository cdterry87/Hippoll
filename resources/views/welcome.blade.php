...
<div class="pt-10 px-6 mx-auto flex flex-wrap md:flex-no-wrap">
    ...
    <div class="flex flex-col w-full xl:w-3/5 py-6 overflow-y-hidden justify-center object-center text-center items-center bg-center">
        ...
        <div class="w-11/12 lg:w-2/3 mx-auto bg-white p-10 rounded border-gray-800 shadow-md">
            @guest
                <h2 class="font-semibold text-center text-2xl text-gray-600 mb-2">Login</h2>
                <h3 class="text-center text-sm text-gray-600 mb-6">And get polling!</h3>
            ...
            @endguest
            @auth
                <h2 class="font-semibold text-center text-2xl text-gray-600 mb-8">Manage Your Polls</h2>
                <a href="/home" class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Get Started
                </a>
            @endauth
        </div>
